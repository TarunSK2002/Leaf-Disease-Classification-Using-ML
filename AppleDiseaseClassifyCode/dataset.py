...
def build_dataloader(batch_size, mode, num_workers=3):
    base_dir = r"D:\project\FGVC-Plant-Pathology-2020-challenge-dataset--master\AppleDiseaseClassifyCode\data_split"
    if mode == 'train':
...
if __name__ == '__main__':
    data_list_file = r"D:\project\FGVC-Plant-Pathology-2020-challenge-dataset--master\AppleDiseaseClassifyCode\data_split\train.txt"
